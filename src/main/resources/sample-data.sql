...
INSERT IGNORE INTO `admin` (username, email, password, adminType)
...
INSERT IGNORE INTO `store` (name, description, isVisible, adminUsername)
VALUES ('Store 1', 'This is store 1', 1, 'admin2'),
       ('Store 2', 'This is store 2', 1, 'admin3'),
       ('Store 3', 'This is store 3', 1, 'admin4');

INSERT IGNORE INTO `product` (name, price, description, isVisible, storeName)
...
INSERT IGNORE INTO `customer` (username, email, password, gender, dateOfBirth)
...
INSERT IGNORE INTO `address` (country, postalCode, city, street, details, isVisible, customerUsername)
...
INSERT IGNORE INTO `order` (status, date, deliveredAt, customerUsername, addressId)
...
INSERT IGNORE INTO `product_order` (orderId, productId, quantity)
VALUES (1, 1, 2),
       (2, 3, 1),
       (3, 2, 3),
       (4, 3, 1),
